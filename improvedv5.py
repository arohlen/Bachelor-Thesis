...
weights = {
    ...
    'wc7': tf.get_variable('W6', shape=(3,3,256,256), initializer=tf.contrib.layers.xavier_initializer()),

    'wd1': tf.get_variable('W7', shape=(4*4*256,128), initializer=tf.contrib.layers.xavier_initializer()),
