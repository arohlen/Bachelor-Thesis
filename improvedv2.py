...
weights = {
    ...
    'wd1': tf.get_variable('W6', shape=(4*4*128,128), initializer=tf.contrib.layers.xavier_initializer()),
...
with tf.Session() as sess:
    ...
    for i in range(training_iters):
        ...
        test_acc,valid_loss = sess.run([accuracy,cost], feed_dict={x: test_x[rand:(rand+5000)],y : test_y[rand:(rand+5000)]})
